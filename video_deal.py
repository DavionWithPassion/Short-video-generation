...
if __name__ == '__main__':  
    ...
    # # Excel读取
    file = 'E:\\Dealing\\MarketingNumber\\code\\v3\\TestCasePre.xls'
    ...
    # 中转文件存储路径
    save_url = 'E:\\Dealing\\MarketingNumber\\code\\v3\\data\\'
    
    # 最终视频存储路径
    result_save_url = 'E:\\Dealing\\MarketingNumber\\code\\v3\\data\\result\\'
